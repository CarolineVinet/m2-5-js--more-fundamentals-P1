...
expect(calculator(["mult", 6, 4]), 24);
expect(calculator(["sub", 0, 9]), -9);
expect(calculator(["mult", 4, 9]), 36);
expect(calculator(["add", 50, 50]), 100);
expect(calculator(["mult", 0, 4]), 0);
expect(calculator(["sub", 40, 1]), 39);
